			...
			<div class="c-shaded ph2 pv2">
				...
				<div class="row between-xs">
					...
					<div class="col-xs-12 col-sm-3 end-sm">
						<span v-if="watched"
						      class="label success mv0 mh2"><i class="fa fa-binoculars mh1"></i>&nbsp;{{lastWatched}}</span>
				...
				<div class="row between-xs mt2">
					<div class="col-xs-12 col-sm-4 addon">
						<input class="addon-field"
						       ...
						       step="1"
						       v-model.number="tmdb" />
						<button class="btn btn-default mr2"
						        @click="fixMovie">Fix</button>
						<div class="mr2">
					...
					<div class="col-xs-12 col-sm-4 addon center-xs">
						<div v-if="watched">
							...
							<select :value="shows[shows.length-1]"
							        class="c-select">
