<template>
  <div class="rating" >
    <i v-for="n in max" class="fa mr1 c-star" :class="[overwritten_value >= n ? 'fa-star' : 'fa-star-o']"  v-on:mouseover="star_over(n)" v-on:mouseout="star_out" v-on:click.stop.prevent="star_selected(n)"></i>
  </div>
</template>
<script>
export default {
